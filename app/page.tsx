...
export default function Home() {
  ...
  return(
    <div className="flex-1 bg-gray-900">
      <div className="absolute bottom-8 left-0 flex flex-col justify-center items-center h-[100%] w-screen bg-sky-600 rounded-b-[150px] cursor-pointer z-10" style={{ animation: animateOut ? 'softBounce 3s ease-in-out infinite, animateOut 1.25s forwards ease-in' : 'softBounce 3s ease-in-out infinite' }} onClick={ () => {setAnimateOut(true); playPopSound()} }>
